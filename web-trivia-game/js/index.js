var animationSetup = false;
 ...
 function animationPipeline() {
   ...
   answers = [
    ['France', 'UK', 'Norway', 'Croatia'],
    ['Tsunami', 'Sayonara', 'Kimono', 'Laksa'],
    ['Thomas Alva Edison', 'Nikola Tesla', 'Michael Faraday', 'Alessandro Volta'],
    ['Moldova', 'Kyrgyzstan', 'Serbia', 'Azerbaijan'],
    ['Queen', 'King', 'Bishop', 'Pawn'],
    ['English', 'Russian', 'French', 'German'],
    ['Cholera', 'Rabies', 'Scarlet Fever', 'Smallpox'],
    ['Shakuntala Devi','Raja Ramanna', 'Ramanujan', 'Rina Panigrahi'],
    ['Marie Curie', 'Benjamin Franklin', 'Albert Einstein', 'Isaac Newton'],
    ['Turkey', 'Russia', 'China', 'Australia']
   ],
   correctAnswers = [2,0,1,2,0,1,3,0,0,2],
   gameAnswers = [];
